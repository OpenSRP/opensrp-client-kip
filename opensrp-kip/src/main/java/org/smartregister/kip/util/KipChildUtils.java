    ...
    public static List<Map<String, String>> populateMohIndicatorsTableFromCSV(Context context, String csvFileName, Map<Integer, String> columns) {
        ...
        try {
            ...
            try {
                ...
                Timber.e(e, "populateMohIndicatorsTableFromCSV: error reading csv file " + Log.getStackTraceString(e));
                ...
                try {
                    ...
                    Timber.e(e, "populateMohIndicatorsTableFromCSV: unable to close inputstream/bufferedreader " + Log.getStackTraceString(e));
                }
            }

        } catch (Exception e) {
            Timber.e(e, "populateMohIndicatorsTableFromCSV " + Log.getStackTraceString(e));
        }
        return result;
    }
