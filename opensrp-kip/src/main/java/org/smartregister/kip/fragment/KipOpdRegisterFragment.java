...
import org.smartregister.kip.activity.KipOpdRegisterActivity;
import org.smartregister.kip.activity.SmsActivity;
    ...
    protected void startRegistration() {
        ...
        popupMenu.setOnMenuItemClickListener(menuItem -> {
            ...
            if (itemId == R.id.opd_menu_register_other_clients) {
                ...
                getActivity().finish();
            } else if (itemId == R.id.opd_menu_send_advocacy_sms){
