...
public class NotInCatchmentDialogFragment extends DialogFragment implements View.OnClickListener {
    private final BaseChildRegisterActivity parentActivity;
    private final String zeirId;

    private NotInCatchmentDialogFragment(BaseChildRegisterActivity parentActivity, String zeirId) {
    ...
    public static NotInCatchmentDialogFragment launchDialog(BaseChildRegisterActivity activity,
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.search_b) {
            if (parentActivity instanceof ChildRegisterActivity) {
                this.dismiss();
                ((ChildRegisterActivity) parentActivity).startAdvancedSearch();
                android.support.v4.app.Fragment currentFragment =
                        ((ChildRegisterActivity) parentActivity).
                                findFragmentByPosition(ChildRegisterActivity
