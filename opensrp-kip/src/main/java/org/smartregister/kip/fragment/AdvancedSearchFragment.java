...
public class AdvancedSearchFragment extends BaseSmartRegisterFragment {
    ...
    private String sortByStatus() {
        return " CASE WHEN " + KipConstants.CHILD_TABLE_NAME + ".inactive  != 'true' is null and " + KipConstants.CHILD_TABLE_NAME + ".lost_to_follow_up != 'true' THEN 1 "
                + " WHEN " + KipConstants.CHILD_TABLE_NAME + ".inactive = 'true' THEN 2 "
                + " WHEN " + KipConstants.CHILD_TABLE_NAME + ".lost_to_follow_up = 'true' THEN 3 END ";
    }
    ...
    private void moveToMyCatchmentArea(final List<String> ids) {
        AlertDialog dialog = new AlertDialog.Builder(getActivity(), R.style.KipAlertDialog)
                .setMessage(R.string.move_to_catchment_confirm_dialog_message)
                .setTitle(R.string.move_to_catchment_confirm_dialog_title)
                .setCancelable(false)
                .setPositiveButton(org.smartregister.kip.R.string.no_button_label, null)
