...
public class OpdRegisterQueryProvider extends OpdRegisterQueryProviderContract {
    ...
    public String mainSelectWhereIDsIn() {
        ...
        String oneDayAgo = OpdUtils.convertDate(latestValidCheckInDate, OpdDbConstants.DATE_FORMAT);
        String sqlQuery =
                "Select  d.id as _id , d.first_name , d.last_name , '' AS middle_name , d.gender , d.dob, d.covid19_risk_factor, d.phone_number, d.reminders,d.covid19_vaccine_eligibility, d.opd_medical_check, d.covid19_waiting_list, d.covid19_vaccine_given, d.covid19_vaccine_next_date,  d.covid19_vaccine_next_number ,'' AS home_address , c.first_name as mother_first_name, c.last_name as mother_last_name, \n" +
