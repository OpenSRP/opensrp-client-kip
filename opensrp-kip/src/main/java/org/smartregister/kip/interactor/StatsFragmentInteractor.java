...
import static org.smartregister.kip.util.Constants.DatabaseKeys.SYNC_STATUS;
import static org.smartregister.kip.util.Constants.DatabaseKeys.VALIDATION_STATUS;
import static org.smartregister.kip.util.Constants.SyncInfo.INVALID_CLIENTS;
import static org.smartregister.kip.util.Constants.SyncInfo.INVALID_EVENTS;
import static org.smartregister.kip.util.Constants.SyncInfo.NULL_EVENT_SYNC_STATUS;
...
public class StatsFragmentInteractor implements StatsFragmentContract.Interactor {
    ...
    public StatsFragmentInteractor(StatsFragmentContract.Presenter presenter) {
        ...
        database = KipApplication.getInstance().getRepository().getReadableDatabase();
    }
