...
public class StartDraftMonthlyMohFormTask extends AsyncTask<Void, Void, Intent> {

    private final Moh710Activity baseActivity;
    private final Date date;
    private final String formName;
    private String reportGrouping;

    public StartDraftMonthlyMohFormTask(@NonNull Moh710Activity baseActivity,
