...
//        detailsMap = childDetails.getColumnmaps();
            ...
            layout.addView(wd.createTableRow(inflater, container, "Child's home health facility", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(KipApplication.getInstance().context(), Utils.getValue(detailsMap, "Home_Facility", false)))));
            ...
            layout.addView(wd.createTableRow(inflater, container, "Health facility the child was born in", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(KipApplication.getInstance().context(), Utils.getValue(detailsMap, "Birth_Facility_Name", false)))));
            if (JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(
                    KipApplication.getInstance().context(), Utils.getValue(detailsMap, "Birth_Facility_Name",
            ...
            layout.addView(wd.createTableRow(inflater, container, "Child's residential area", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(KipApplication.getInstance().context(), Utils.getValue(detailsMap, "address3", false)))));
            if (JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(
                    KipApplication.getInstance().context(),
