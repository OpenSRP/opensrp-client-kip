...
//        layout.addView(createTableRow(inflater,container,"Catchment Area","Linda"));
    ...
    public void loadData() {
        if (layout != null && container != null && inflater != null) {
            ...
            layout.addView(wd.createTableRow(inflater, container, "Child's registration facility", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "Home_Facility", true)))));
