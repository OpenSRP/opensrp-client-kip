package org.smartregister.kip.watchers;
...
public class LookUpTextWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (formFragment instanceof KipJsonFormFragment) {
            KipJsonFormFragment kipJsonFormFragment = (KipJsonFormFragment) formFragment;
            context = kipJsonFormFragment.context();
            listener = kipJsonFormFragment.motherLookUpListener();
        }
