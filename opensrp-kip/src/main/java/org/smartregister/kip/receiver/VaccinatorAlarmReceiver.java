...
public class VaccinatorAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent alarmIntent) {
        ...
        if (!KipApplication.getInstance().context().IsUserLoggedOut()) {
            ...
            switch (serviceType) {
                case KipConstants.ServiceType.DATA_SYNCHRONIZATION:
                ...
                case KipConstants.ServiceType.MONTHLY_TALLIES_GENERATION:
                    ...
                    break;
                case KipConstants.ServiceType.PULL_UNIQUE_IDS:
                    ...
                    break;
                case KipConstants.ServiceType.WEIGHT_SYNC_PROCESSING:
                    ...
                    break;
                case KipConstants.ServiceType.VACCINE_SYNC_PROCESSING:
                    ...
                    break;
                case KipConstants.ServiceType.RECURRING_SERVICES_SYNC_PROCESSING:
