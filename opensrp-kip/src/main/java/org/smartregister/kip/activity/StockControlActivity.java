...
import org.smartregister.kip.tabfragments.CurrentStock;
import org.smartregister.kip.tabfragments.PlanningStockFragment;
...
public class StockControlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AllSharedPreferences allSharedPreferences = KipApplication.getInstance().context().allSharedPreferences();
    ...
    private void initializeCustomNavbarLIsteners() {
        ...
        String preferredName = KipApplication.getInstance().context().allSharedPreferences().getANMPreferredName(
                KipApplication.getInstance().context().allSharedPreferences().fetchRegisteredANM());
...
//                startJsonForm("out_of_catchment_service", null);
        ...
        childregister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KipApplication.setCrashlyticsUser(KipApplication.getInstance().context());
...
//    }
    ...
    public int getcurrentVialNumber() {
        net.sqlcipher.database.SQLiteDatabase db = KipApplication.getInstance().getRepository().getReadableDatabase();
