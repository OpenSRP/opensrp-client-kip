    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_GET_JSON && resultCode == RESULT_OK) {
            try {
                ...
                KipApplication.getInstance().monthlyTalliesRepository()
                        .save(result, month);
                if (saveClicked) {
                    sendReport(month);
                }
    ...
    public static class StartDraftMonthlyFormTask extends AsyncTask<Void, Void, Intent> {
        ...
        protected Intent doInBackground(Void... params) {
            try {
                ...
                HIA2IndicatorsRepository hIA2IndicatorsRepository = KipApplication
                ...
                Intent intent = new Intent(baseActivity, KipJsonFormActivity.class);
