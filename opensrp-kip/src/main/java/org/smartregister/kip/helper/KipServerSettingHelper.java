package org.smartregister.kip.helper;
...
public class KipServerSettingHelper {

    public static List<KipServerSetting> serverSettings;

    private static final Type SERVER_SETTING_TYPE = new TypeToken<List<KipServerSetting>>() {
    }.getType();

    public KipServerSettingHelper(String key) {
        initializeServerSettings(key);

    }

    public List<KipServerSetting> getServerSettings() {
        return serverSettings;
    }

    public static List<KipServerSetting> fetchServerSettingsByTypeKey(String typeKey) {
        try {
            Gson gson = new Gson();
    ...
    private static void initializeServerSettings(String key) {
        ...
        serverSettings = KipServerSettingHelper.fetchServerSettingsByTypeKey(key);
    }
}
