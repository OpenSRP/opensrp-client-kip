...
public class KipProcessorForJava extends ClientProcessorForJava {
    ...
    private static final String TAG = KipProcessorForJava.class.getName();
    ...
    private boolean unSync(List<Event> events) {
        try {
            ...
            return clientField != null;//DetailsRepository detailsRepository = KipApplication.getInstance().context().detailsRepository();
